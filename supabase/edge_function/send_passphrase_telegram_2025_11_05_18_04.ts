...
// Generate 24-word passphrase from BIP39 word list
function generatePassphrase(): string {
  const words = [
    ...
    'pale', 'palm', 'panda', 'panel', 'panic', 'panther', 'paper', 'parade', 'parent', 'park',
    'parrot', 'part', 'party', 'pass', 'patch', 'path', 'patient', 'patrol', 'pattern', 'pause',
    ...
    'quantum', 'quarter', 'question', 'quick', 'quiet', 'quilt', 'quit', 'quiz', 'quote', 'rabbit',
    ...
    'ripple', 'rise', 'risk', 'ritual', 'rival', 'river', 'road', 'roast', 'rob', 'robot',
    ...
    'shed', 'shell', 'sheriff', 'shield', 'shift', 'shine', 'ship', 'shirt', 'shock', 'shoe',
    ...
    'sock', 'soda', 'soft', 'solar', 'sold', 'soldier', 'solid', 'solution', 'solve', 'someone',
    ...
    'surprise', 'surround', 'survey', 'suspect', 'sustain', 'swallow', 'swamp', 'swap', 'swear', 'sweet',
    ...
    'weasel', 'weather', 'web', 'wedding', 'weekend', 'weird', 'welcome', 'west', 'wet', 'what',
